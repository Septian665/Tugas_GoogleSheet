...
String Sheets_GAS_ID = "AKfycbzMyvedLEaPtPOcuaJrR-ynmlyGdIfgPEVfcY4qJpoPtj0VdNd8d0W3IKg1rj9ZzINrpw";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("Wifi.Id_plus","septian21");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
